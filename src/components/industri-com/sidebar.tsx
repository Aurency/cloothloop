...
const navLinks = [
  { name: "Home", href: "/industri", icon: <FiHome size={20} /> },
  { name: "Activity", href: "/industri/delivery", icon: <HiOutlineClock size={20} /> },
  { name: "Profile", href: "/industri/profil", icon: <FiUser size={20} /> }
];
