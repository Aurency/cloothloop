        ...
        <div className="flex flex-col min-h-screen">
            ...
            <section className="bg-[#F2E8D8]">
                <div className="text-center">
                    <h2 className="text-4xl font-semibold text-green-900 mb-2 py-10 bg-[#F2E8D8]/50">
                        Kategori limbah textile</h2>
                </div>
            ...
            <section className=" bg-[#F2E8D8] pb-5">
                <div className="text-center">
                    <h2 className="text-4xl font-semibold text-green-900 py-10 bg-[#F2E8D8]/50">
                        Partner with us</h2>
                </div>
