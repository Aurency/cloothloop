...
export default  function Partner() {
  return (
    <div className="flex justify-center items-center min-h-screen bg-[#F2E8D8] px-4">
      <div className="max-w-4xl w-full p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          <p className="text-lg text-[#0A4635] mb-4">
          ...
          <Link href="/signup" className="px-6 py-2 mt-4 text-lg font-medium text-[#0A4635] bg-[#FFEA7F] hover:bg-[#fcde49] rounded-[24px]">
            Gabung
          </Link>
        </div>
